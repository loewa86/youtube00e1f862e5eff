...
DEFAULT_KEYWORDS = \
    ...
    "Web3Platforms", "DecentralizedIdentity", "CyberThreats", "AIResearch", "DeepLearning", "Bloomberg", "new technology", "new startup", "new erc20 token", "new crypto",
    "RoboticAutomation", "IoTDevices", "SpaceXLaunches", "CRISPRTechnology", "PrecisionMedicine", "new world order",
